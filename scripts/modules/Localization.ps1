...
$Script:Strings = @{
    ...
    "FR" = @{
        ...
        HwTitle           = "Matériel"
        FlexyModelLabel   = "Modèle Flexy :"
        FlexyModel202     = "Flexy 202"
        FlexyModel205     = "Flexy 205"
        FwTitle           = "Firmware"
