...
$Script:ParameterDefinitions = @(
    ...
    @{File="config.txt"; Param="Timezone"; Default="Europe/Paris"; Description="Desc_Timezone"; Type="Timezone"; AlwaysAsk=$true; ConnectionType=$null; Condition=$null; Value4G=$null; ValueEthernet=$null; ValueDatalogger=$null; Choices=$null; Group="Group_NTP"}
